...
const WorkerRegistration = () => {
  ...
  const handleSendOTP = async (e) => {
    ...
    // Ensure phone has country code (simple check)
    ...
    navigator.geolocation.getCurrentPosition(
      async (position) => {
        try {
          ...
          setLocation(data.display_name); // full readable address
          setLat(data.lat);
          setLon(data.lon);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-900/20 via-slate-950 to-slate-950 p-6 relative overflow-hidden">
      ...
      >
        ...
        <div className="text-center mt-6 mb-10">
          <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-indigo-500/20 text-indigo-400 mb-4 shadow-[0_0_20px_rgba(99,102,241,0.2)]">
            <Sparkles className="w-6 h-6" />
          </div>
          <h2 className="text-3xl font-bold text-white mb-2">Worker Registration</h2>
          <p className="text-slate-400 text-sm">Join our platform to find daily jobs</p>
        </div>
          ...
          <AnimatePresence mode="wait">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-12 pr-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                ...
                <form onSubmit={handleVerifyOTP} className="flex flex-col h-full">
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      className="block w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 text-center tracking-[0.5em] text-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                      placeholder="------"
                      required
                    />
                  </div>
                  ...
                  <div className="space-y-4 mb-4">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="block w-full pl-12 pr-12 py-3 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all"
                      ...
                      <button
                        ...
                        className="absolute inset-y-0 right-0 pr-3 flex items-center text-slate-400 hover:text-indigo-400 disabled:opacity-50"
            ...
            {step === 4 && (
              ...
              >
                ...
                <p className="text-slate-400 mb-8">Your profile has been successfully verified.</p>
                <button
                  onClick={() => navigate('/worker_dashboard')}
                  className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 text-white font-semibold rounded-full transition-colors"
                >
                  Find Jobs Near Me
                </button>
              </motion.div>
